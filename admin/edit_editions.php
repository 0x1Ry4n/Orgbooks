									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input id="autor" value="<?php
												...
												foreach ($autor as $a) {
													echo ($a->value . ",", ENT_QUOTES | ENT_HTML5, 'UTF-8');
												}
								...
								<div style="display: flex; justify-content: center" class="row">
									<div class="form-group">
										<div class="modal-footer justify-content-center">
											<button id="edit" class="btn btn-primary" name="submit" data-toggle="modal"><i class="fa-solid fa-pen"></i> Atualizar</button>
											<button type="reset" id="reset" class="btn btn-primary" data-toggle="modal"><i class="fa-solid fa-repeat"></i> Limpar</button>
										</div>
									</div>
								</div>
							</form>
								...
								<table class="data-table table stripe hover nowrap">
									<thead>
										<tr>
											...
											<th class="datatable-nosort"><i class="ion-person"></i> AUTOR</th>
