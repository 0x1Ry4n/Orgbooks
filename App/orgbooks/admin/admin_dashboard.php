		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center mx-auto">
					...
					<div class="row">
						<div class="message">
							<h1 class="font-24 weight-800 text-capitalize" data-color="#192931">Seja bem-vindo</h1>
							<span class="weight-800 font-30" data-color="gray">
								<?php echo htmlentities(ucfirst($row['nome']), ENT_QUOTES | ENT_HTML5, 'UTF-8') ?>,
							</span>
							<h1 class="font-24 weight-800 max-width-600">
								Hoje é
								<?php
					...
					<div class="col-lg-4 col-md-6 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							<div class="d-flex justify-content-between pb-10">
								<p class="h5 mb-0 mx-auto"><i class="bell fa-solid fa-bell" data-color="#192931"></i> Notificações</p>
							</div>
							<div class="scroll">
								<ul>
									<?php
										...
										<li class="d-flex align-items-center justify-content-between mt-10" style="border: solid 2px whitesmoke; padding: 8px; border-radius: 10px;">
											<div class="txt">
												...
												<span class="font-14 weight-500" data-color="gainsboro"> <?php echo "<i class='fa-solid fa-gavel'></i> ". implode('/', array_reverse(explode('-', $data_retirada))); ?> <i class="fa-solid fa-arrow-right"></i> </span>
