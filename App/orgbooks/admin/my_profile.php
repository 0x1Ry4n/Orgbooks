							...
							<div class="col-lg-4">
								<div class="card mb-4">
									<div class="card-body text-center">
										<div></div>
										<a href="modal" data-toggle="modal" data-target="#modal" class=""><i style="transform: scaleX(-1); background-color: whitesmoke; padding: 10px; border-radius: 50%; filter: drop-shadow(0 4px 5px rgba(0,0,0,.3));" class="fa fa-pencil"></i></a>
