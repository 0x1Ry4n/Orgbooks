(function() {
	...
	$(document).ready(function() {
		...
		let left_sidebar = jQuery('.left-side-bar');


		// Header Background
		let header_dark = jQuery('.header-dark');
		let header_light = jQuery('.header-white');
		...
		// Sidebar Background
		let sidebar_dark = jQuery('.sidebar-dark');
		let sidebar_light = jQuery('.sidebar-light');
